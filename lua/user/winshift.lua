...
vim.keymap.set("n", "<C-M-j>", "<Cmd>WinShift down<CR>", { noremap = true })
vim.keymap.set("n", "<C-M-k>", "<Cmd>WinShift up<CR>", { noremap = true })
vim.keymap.set("n", "<C-M-l>", "<Cmd>WinShift right<CR>", { noremap = true })
